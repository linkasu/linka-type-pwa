...
const steps = computed(() => [
  ...
  {
    title: t('tutorial.typing.title'),
    content: t('tutorial.typing.content'),
    icon: 'mdi-keyboard',
  },
  {
    title: t('tutorial.quickes.title'),
    content: t('tutorial.quickes.content'),
  ...
  {
    title: t('tutorial.shortcuts.title'),
    content: t('tutorial.shortcuts.content'),
