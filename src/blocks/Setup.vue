    ...
    <v-stepper-items>
      <v-stepper-content step="1">
        <blockquote class="blockquote">
          ...
          <p>Я надеюсь, что этот коммуникатор станет неотъемлемой частью вашей жизни. С помощью него вы сможете общаться с близкими, находить новых друзей, выступать с речами на семейных застольях или важных мероприятиях.</p>
          <footer align="right">
      ...
      <v-stepper-content step="2">
        <blockquote class="blockquote">
          ...
          <p>Выберете из списка голсов ниже русскоязычный или же включите озвучку Яндекс.</p>
          <p><b>
            Внимание!</b> Если у вас iOS устройство, включите звук уведомлений, инвче ничего не услышите.</p>
        </blockquote>
          ...
          <v-layout row wrap>
            <v-flex xs12 md4 lg3>
              <v-card>
                ...
                <v-card-text>
                  <i>Нажмите кнопку "Послушать код" и введите его в поле ввода.</i>
                  <br />
                  <v-text-field
                    v-model="checkCode"
